...
export function QRGeneratorPage() {
    ...
    const generateSession = () => {
        ...
        // Use HashRouter format: /#/order/token
        // This works on GitHub Pages without 404s
        let baseUrl = window.location.origin + window.location.pathname.replace(/\/$/, ''); // Include base path if any (/Kath)
